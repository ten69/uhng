        ...
        <!-- <form id="formtest" novalidate="novalidate"> -->
            <style>
                ...
                <div class="area_other" style="margin: 20px 0">                    
                    <div class="address ">
                        <label class="choose"><i class="iconmobile-opt"></i>&nbsp;Đã có tài khoản</label></a>
                    </div>
                    <div class="supermarket">
                        <a href="dang-ky.html"><label class=""><i class="iconmobile-opt"></i>&nbsp;Chưa có tài khoản</label></a>
                    </div>
                ...
                <div class="infouser ">
                    ...
                    <div class="areainfo">
                        <div class="left">
                            ...
                            <input type="text" class="saveinfo" name="" placeholder="" maxlength="50" value="">
                        </div>


                        <div class="right">
                            <span>Mật khẩu</span>
                            <input type="password" class="saveinfo" name="" placeholder="" maxlength="30" value="">
                        </div>   
    ...
    $(".saveinfo").blur(function() {            
        ...
        if(_val == ''){                        
            ...
            _span.css('top','26px')
                ...
                <div class="">
                    <a href="javascript:void(0)" class="payoffline">Đăng nhập</a>
                </div>
