    ...
    <title>Apple Macbook Air MQD42SA/A - Chính hãng giá tốt | Thegioididong</title>
    <meta name="keywords" content="Mua Apple Macbook Air MQD42SA/A i5 1.8GHz/8GB/256GB (2017), mua online Apple Macbook Air MQD42SA/A i5 1.8GHz/8GB/256GB (2017), Apple Macbook Air MQD42SA/A i5 1.8GHz/8GB/256GB (2017)" />
    <meta name="description" content="Laptop Macbook Air MQD42SA/A chính hãng i5 Kaby Lake, RAM 8 GB, ổ cứng SSD 256 GB. Có bán trả góp, bảo hành 12 tháng, giá tốt cạnh tranh với thị trường, giao hàng miễn phí toàn quốc, lỗi đổi mới trong 1 tháng, phục vụ chuyên nghiệp, tận tâm. Laptop có khuyến mãi. Xem ngay." />
    <meta itemprop="image" content="<?= $assetsPrefix?>/jpg/apple-macbook-air-mqd42sa-a-i5-5350u-8gb-256gb-bac-450x300-450x300.jpg" />
    <meta property="og:url" itemprop="url" content="apple-macbook-air-mqd42sa-a-i5-5350u" />
    <meta property="og:title" content="Apple Macbook Air MQD42SA/A - Chính hãng giá tốt | Thegioididong" />
    <meta property="og:description" content="Laptop Macbook Air MQD42SA/A chính hãng i5 Kaby Lake, RAM 8 GB, ổ cứng SSD 256 GB. Có bán trả góp, bảo hành 12 tháng, giá tốt cạnh tranh với thị trường, giao hàng miễn phí toàn quốc, lỗi đổi mới trong 1 tháng, phục vụ chuyên nghiệp, tận tâm. Laptop có khuyến mãi. Xem ngay." />
    <meta property="og:image" content="<?= $assetsPrefix?>/jpg/apple-macbook-air-mqd42sa-a-i5-5350u-8gb-256gb-bac-450x300-450x300.jpg" />
    <link rel="canonical" href="apple-macbook-air-mqd42sa-a-i5-5350u" />
    ...
    <style>
        ...
        .fotorama__video-close,
        .fotorama__video-play {
            background: url(<?= $assetsPrefix?>/png/fotorama.png) no-repeat
        }
        ...
        * {
        ...
        [class^="iconmobile-"],
        [class*="iconmobile-"] {
            background-image: url(<?= $assetsPrefix?>/png/icondesktop%401x.png);
            background-repeat: no-repeat;
            display: inline-block;
            height: 30px;
            width: 30px;
        ...
        .icondetail-closepara {
            background-image: url(<?= $assetsPrefix?>/png/icondetail%401x.png);
        ...
        [class^="iconcom-"],
        [class*="iconcom-"] {
            background-image: url(<?= $assetsPrefix?>/png/commentmobile%402x.png);
        ...
        .wrap_comment .inputreply .textarea {}
        ...
        .wrap_comment .statistical .notifyChat {}
        ...
        /* 02:46:42 08/06/2018 */
        .cpNoel {
            background: url(<?= $assetsPrefix?>/png/teaserae52.png?v=5);
            text-align: center;
            margin: 0 10px 10px;
            height: 80px;
            position: relative;
        ...
        .cpNoelKm {
            background: url(<?= $assetsPrefix?>/png/teaser2ae52.png?v=5) no-repeat;
            margin: 10px auto;
            max-width: 600px
        }
        ...
        .cpit {
            background: url(<?= $assetsPrefix?>/png/bnpkae52.png?v=5);
            background-repeat: no-repeat;
        ...
        @media screen and (max-width: 640px) {
            .cpNoel,
            .cpNoelKm {
                background: url(<?= $assetsPrefix?>/png/teasermbae52.png?v=5);
                background-size: 100%;
                box-sizing: border-box;
                background-repeat: no-repeat;
                margin: 5px 0 10px;
            ...
            .cpit,
            .cpit.cpNoelKm {
                background: url(<?= $assetsPrefix?>/png/tsxtmbae52.png?v=5);
                width: 100%;
                background-repeat: no-repeat;
                background-size: 100%
            }
        ...
        /* 12:03:17 07/08/2018 */
        .cpGift {
            background: url(<?= $assetsPrefix?>/png/bgctt1c07.png?v=17);
            text-align: center;
            margin: 0 10px 10px;
            height: 100px;
            position: relative;
        ...
        .cpGift.cpGit.type0 {
            background: url(<?= $assetsPrefix?>/png/desk-380x100-golive-type01c07.png?v=17);
            background-size: 100%
        }

        .cpGift.cpGit.type1 {
            background: url(<?= $assetsPrefix?>/png/desk-380x100-golive-type11c07.png?v=17);
            background-size: 100%
        }

        .cpGift.cpGit.type2 {
            background: url(<?= $assetsPrefix?>/png/desk-380x100-golive-type21c07.png?v=17);
            background-size: 100%
        }
        ...
        .cpTeaser {
            background: url(<?= $assetsPrefix?>/jpg/teaser1c07.jpg?v=17);
            height: 70px;
            background-repeat: no-repeat
        }

        .cpTeaserApple {
            background: url(<?= $assetsPrefix?>/jpg/teaserapple1c07.jpg?v=17);
            height: 70px;
            background-repeat: no-repeat
        }
        ...
        .wrapcp .wrapPop button.cc {
            background: none;
            border: 1px solid #fff
        }

        .cpGit .open img.cpg1 {
            -webkit-animation: cpgift 1s linear 1s infinite alternate;
            animation: cpgift 1s linear 1s infinite alternate
        }

        .cpGit .open img.cpg2 {
            -webkit-animation: cpgift 1s linear 2s infinite alternate;
            animation: cpgift 1s linear 1s infinite alternate
        }
        ...
        @media screen and (max-width: 640px) {
            .cpGift {
                background: url(<?= $assetsPrefix?>/png/bgcttmb1c07.png?v=17);
                background-size: 100%;
                -moz-box-sizing: border-box;
                -webkit-box-sizing: border-box;
                box-sizing: border-box;
            ...
            .cpGift.cpGit.type0 {
                background: url(<?= $assetsPrefix?>/png/mb-640x160-golive-type01c07.png?v=17);
                background-size: 100%;
                -moz-box-sizing: border-box;
                -webkit-box-sizing: border-box;
                box-sizing: border-box;
            ...
            .cpGift.cpGit.type1 {
                background: url(<?= $assetsPrefix?>/png/mb-640x160-golive-type11c07.png?v=17);
                background-size: 100%;
                -moz-box-sizing: border-box;
                -webkit-box-sizing: border-box;
                box-sizing: border-box;
            ...
            .cpGift.cpGit.type2 {
                background: url(<?= $assetsPrefix?>/png/mb-640x160-golive-type21c07.png?v=17);
                background-size: 100%;
                -moz-box-sizing: border-box;
                -webkit-box-sizing: border-box;
                box-sizing: border-box;
            ...
            .cpTeaser {
                background: url(<?= $assetsPrefix?>/jpg/teasermb1c07.jpg?v=17);
                background-repeat: no-repeat;
                background-size: 100%;
                height: auto
            }
            ...
            .cpTeaserApple {
                background: url(<?= $assetsPrefix?>/jpg/teaserapplemb1c07.jpg?v=17);
                background-repeat: no-repeat;
                background-size: 100%;
                height: auto
            }
       ...
       /* .area_promotion strong {
        ...
        .area_promotion .infopr span:before {
            content: '';
            margin-left: -20px;
            background: url(<?= $assetsPrefix?>/png/check%402x.png);
            width: 14px;
            height: 14px;
        ...
        .area_promotion .onlinepromo b:before {
            content: '';
            background: url(<?= $assetsPrefix?>/png/icon-qua-tang%402x.png);
            width: 16px;
            height: 15px;
        ...
        .policy li .icon-poltick {
            content: '';
            background: url(<?= $assetsPrefix?>/png/1-doi-1%402x.png) 0 0 no-repeat;
            width: 16px;
            height: 18px;
        ...
        .policy .inpr:before {
            content: '';
            background: url(<?= $assetsPrefix?>/png/trong-hop-co%402x.png) 0 0 no-repeat;
            width: 19px;
            height: 16px;
        ...
        .policy .wrpr:before {
            content: '';
            background: url(<?= $assetsPrefix?>/png/bao-hanh-chinh-hang%402x.png) 2px 0 no-repeat;
            width: 19px;
            height: 23px;
        ...
        .policy .shpr:before {
            content: '';
            background: url(<?= $assetsPrefix?>/png/giao-hang%402x.png) 2px 0 no-repeat;
            width: 24px;
            height: 16px;
        ...
        #owl-detail .owl-buttons .owl-prev {
            float: left;
            background: url(<?= $assetsPrefix?>/png/icondesktop%401x.png) no-repeat;
        ...
        .sggProd .search-suggestion-wrapper {}
